...
def text2img(req: Text2ImgRequest, background: BackgroundTasks,
    ...
    background.add_task(_run_task, task.id, None)
...
async def img2img(background: BackgroundTasks,
    ...
    background.add_task(_run_task, task.id, ref_bytes)
